...
**Status**: RESOLVED — Added blanket auth note at the top of the API Endpoints section covering both endpoints, and added explicit 401/403 rows to the PATCH error response table in `docs/features/platform/system-settings.md`. (2026-05-06)
