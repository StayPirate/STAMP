...
- [ldap-directory.md](identity/ldap-directory.md) — SUSE AD sync, role mapping
- [user-lifecycle.md](identity/user-lifecycle.md) — Service-layer contract for user mutations
